...
include 'config.php';
// require 'vendor/autoload.php'; // Ensure vendor folder exists
...
function sendOrderEmail($email, $name, $products, $total, $date, $method, $address) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'himanshushukla2297@gmail.com'; 
        $mail->Password = 'omcx pxtv cyzs tvdm'; 
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        $mail->setFrom('himanshushukla2297@gmail.com', 'book bhandar');
